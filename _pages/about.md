...
- [GitHub](https://github.com/tomfuertes)
- [LinkedIn](https://linkedin.com/in/tomfuertes)
- [Twitter](https://twitter.com/thisbetom)
...
<script>
(function(){
  var a=atob('dG9tZnVlcnRlc0BnbWFpbC5jb20='),
      b=atob('dG9tQHRvbWZ1ZXJ0ZXMuY29t'),
      c=atob('dG9tQG5vdGFtYm91cmluZS5jb20=');
  document.getElementById('em').innerHTML=[a,b,c].join('<br>');
})();
</script>
